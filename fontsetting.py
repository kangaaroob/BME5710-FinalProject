...
def font_cmu(plt):
    import os
    os.environ["PATH"] += os.pathsep + "/usr/local/texlive/2024/bin/universal-darwin"  # This line is needed for macOS; update path on the location f TexLive on your system
